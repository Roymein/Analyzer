...
import static com.example.analyze.xml.utils.TransformUtils.reverseBytes;

public class BytesReader {

    private int position = 0; // Mark the sequential read position
    private byte[] data;
    ...
    /**
     * @param count Byte number
     * @return little endian byte arrays
     */

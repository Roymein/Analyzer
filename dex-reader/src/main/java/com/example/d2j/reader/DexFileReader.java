...
import com.example.d2j.node.DexAnnotationNode;
import com.example.d2j.util.Mutf8;
...
import static com.example.d2j.DexConstants.DEX_037;
...
public class DexFileReader implements BaseDexFileReader {
    ...
    public DexFileReader(ByteBuffer in) {
        ...
        if (version < 0 || version < DexConstants.DEX_035) {
    ...
    public static void niceExceptionMessage(Throwable t, int deep) {
        ...
        sb.append(".".repeat(Math.max(0, deep)));
        sb.append(' ');
